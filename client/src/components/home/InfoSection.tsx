        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="prose prose-lg text-muted-foreground">
              <p className="mb-4">
                भारदेनगर (Bharadenagar) हे नाशिक जिल्ह्यातील मालेगाव तालुक्यात असलेले एक गाव आहे, जे मालेगाव उपजिल्हा मुख्यालयापासून सुमारे २० किमी आणि जिल्हा मुख्यालय नाशिकपासून सुमारे १२५ किमी अंतरावर आहे.
              </p>
              <p className="mb-4">
                भारदेनगर हे मालेगाव पंचायत समितीच्या अखत्यारीत येते. गावात ३ वार्ड असून ९ ग्रामपंचायत पदाधिकारी आहेत. गाव आपल्या कृषी संपन्नतेसाठी आणि शांततेसाठी ओळखले जाते.
              </p>
            </div>
          </div>
